      ...
      <div id="contact-form" className="container absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-opacity-60 bg-black p-8 rounded-2xl ">
        ...
        <form className='text-black flex xl:gap-x-10'>
          ...
          <div className='xl:w-[800px] w-full'>
            ...
            <motion.button variants={fadeIn('up', 0.1)} initial="hidden" animate="show" exit="hidden" type="submit" className="bg-orange-300 hover:bg-accent  text-black hover:text-white htransform hover:scale-105 transition-transform duration-300 ease-in-out font-semibold py-2 px-4 rounded">
              Submit
            </motion.button>
          </div>
        </form>
