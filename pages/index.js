...
const Home = () => {
  return (
    <div className="bg-primary/60 h-full overscroll-y-auto">
      {/* text  */}
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 p-y-20 xl:text-left h-full container mx-auto">
          {/* title  */}
